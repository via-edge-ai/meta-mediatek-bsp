...
FILESEXTRAPATHS:prepend:genio-1200-evk-p1v1 := "${THISDIR}/mt8395-evk-p1v1:"
FILESEXTRAPATHS:prepend:genio-510-evk := "${THISDIR}/mt8370-evk:"
FILESEXTRAPATHS:prepend:som-7000 := "${THISDIR}/mt8395-evk:"
